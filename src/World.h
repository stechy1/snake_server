...
private:
    ...
    void updateSnake(int uid, std::shared_ptr<GameObject::Snake> snake);
    ...
    std::map<int, std::shared_ptr<GameObject::Snake>> m_snakesToAdd; // TODO snake -> sharedPointer
